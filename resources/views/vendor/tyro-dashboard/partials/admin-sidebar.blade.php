...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav sidebar-accordion" data-sidebar-accordion
        ...
        <div class="sidebar-section">
            ...
            <!-- Custom Reports link (already localized) -->
            ...
            <!-- Custom Recipe Cards link (already localized) -->
            ...
            <!-- Custom Stock Deliveries link (already localized) -->
            ...
            <!-- Custom Profitability link (already localized) -->
                ...
                @foreach ($allResources ?? config('tyro-dashboard.resources', []) as $key => $resource)
                    ...
                    @if ($canAccess)
                        <a href="{{ route($dashboardRoute::name('resources.index'), $key) }}"
                            ...
                            @endif
                            <!-- 🚀 LOCALIZED: Dynamic resource title (Catégories / Produits / Orders) -->
                            {{ __($resource['title']) }}
                        </a>
                    @endif
                @endforeach
